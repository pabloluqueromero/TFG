        ...
        if index:
            ...
            for i in sort_index:
                ...
                self.feature_values_count_per_element_.insert(
                    list_insert_index, new_feature_value_counts_per_element[column])
                self.feature_values_count_ = np.insert(
                    self.feature_values_count_, list_insert_index, new_feature_value_counts[column])
                ...
                self.feature_unique_values_count_ = np.insert(
                    self.feature_unique_values_count_, list_insert_index, new_feature_unique_values_count_[column])
        else:
            ...
            self.feature_unique_values_count_ = np.concatenate(
                [self.feature_unique_values_count_, new_feature_unique_values_count_])
